  ...
  <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
    ...
    <div class="col-span-1">
      <form class="relative">
        <label>
          <input
            class="appearance-none bg-gray-200 rounded py-4 px-4 pl-12 w-full text-gray-700 leading-tight focus:outline-none focus:bg-white focus:shadow-md"
            name="keyword" type="text" placeholder="Search posts">
        </label>
        <div class="absolute inset-y-0 left-0 pl-4 flex items-center">
          <svg class="fill-current text-gray-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
            height="24">
      ...
      <div class="flex flex-wrap gap-4">
        ...
        <a href="blogs.php?tag=<?php echo $tag['category'] ?>" class="text-decoration-none">
          <button
            class="bg-blue-500 hover:bg-blue-600 focus:bg-blue-700 text-white py-2 px-2 rounded transition-colors duration-300 ease-in-out border border-blue-700 text-sm">
